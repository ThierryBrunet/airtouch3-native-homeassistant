class DaikinAcPanel extends HTMLElement {
  ...
  render() {
    ...
    const thermostatMode =
      attrs.thermostat_mode_name ?? attrs.thermostat_mode ?? "—";
    const tempSource = attrs.active_temperature_source ?? "—";
    const touchPadTemp = attrs.touch_pad_temperature ?? "—";
        ...
        <div class="panel">
          ...
          <div class="status">
            <div class="status-meta">
              ...
              <div><strong>Thermostat:</strong> ${thermostatMode} (${tempSource})</div>
              <div><strong>Touch pad:</strong> ${touchPadTemp}°C</div>
            </div>
