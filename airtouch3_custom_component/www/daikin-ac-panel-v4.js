  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .zone.off .zone-control-value { color: #bdbdbd; }
        .zone-control-btn {
          width: 28px;
          height: 28px;
          flex: 0 0 28px;
    ...
    return `
      <div class="zone ${isOn ? "on" : "off"}">
        ...
        <div class="zone-control">
          ...
          >−</button>
          <span class="zone-control-value">${damperLabel}</span>
          <button
            class="zone-control-btn"
        ...
        <div class="zone-control">
          ...
          >−</button>
          <span class="zone-control-value">Target ${target}°C</span>
          <button
            class="zone-control-btn"
